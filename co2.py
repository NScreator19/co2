...
Original file is located at
    https://colab.research.google.com/drive/14b_yXXzGmKH_ZvmkcfEUJ4QYIgRwe1in
"""
...
@st.cache_data(ttl=0)
def load_data():
    url = "https://raw.githubusercontent.com/NScreator19/sim-CF-CO2/main/Clinker_Factor_2025.xlsx"
    df_raw = pd.read_excel(url, sheet_name="MTD")
    return df_raw
...
co2_fuel = stec * fuel_ef * (1 - tsr / 100) * clinker_factor / 100000
